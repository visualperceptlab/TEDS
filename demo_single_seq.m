...
setup_paths();
% addpath('D:\matlab2021a\toolbox\opencv_341\mexopencv');
...
% Run tracker
results = run_LEA(seq); % deep and hand-crafted features are used
% results = run_LEA_HC(seq); % only hand-crafted features are used
